// 初始化Supabase
const supabaseUrl = 'https://fmumxkriynocaalyrmjc.supabase.co';
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZtdW14a3JpeW5vY2FhbHlybWpjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODg1Mjk4NjYsImV4cCI6MjEwNDEwNTg2Nn0.1LJ5U7Rzh4JeCKkPhN9SunS7e2o4-XDMF-ayUd4OymE';
...
async function getBugs(){
  ...
  if(error){ console.error('获取Bug失败:', error); return []; }
  return data || [];
}
